...
class BtcMigrationSourceStepExecution extends AbstractBtcStepExecution {
     ...
     * 0. Starts up / connects to EP
     * 1. Loads an existing profile or creates a new one
     * 2. Imports existing vectors (optional)
     * 3. Creates Domain Check goals (optional)
     * 4. Generates vectors for structural coverage
     * 5. Simulates on the desired execution configs
     * 6. Exports the execution records
     * 7. Saves the profile
     */
    @Override
    protected void performAction() throws Exception {
        ...
        jenkinsConsole.println("--> [200] Migration Source successfully executed.");
        response = 200;
    }

    /**
     * Saves the profile, prepares the source-part of the report and dumps it to a file.
     *
     * @throws ApiException
     */
    ...
    /**
     * Exports the execution records and moves them to a user defined folder in case the profile is being used directly.
     *
     * @throws Exception
     */
    public void storeExecutionRecords() throws Exception {
        ...
        // can't initialize the APIs statically (the right API client has not been set at that time) 

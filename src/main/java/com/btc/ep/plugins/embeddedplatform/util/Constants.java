...
public class Constants {
    ...
    public static List<String> getKnownCompilerPreferenceValues() {
        return Arrays.asList(
    		PREF_COMPILER_GCC_VALUE,
            PREF_COMPILER_MINGW_VALUE,
            PREF_COMPILER_MSVC170_VALUE,
            PREF_COMPILER_MSVCPP170_VALUE,
            PREF_COMPILER_MSVC160_VALUE,
            PREF_COMPILER_MSVCPP160_VALUE,
            PREF_COMPILER_MSVC150_VALUE,
            PREF_COMPILER_MSVCPP150_VALUE,
            PREF_COMPILER_MSVC130_VALUE,
            PREF_COMPILER_MSVC120_VALUE,
            PREF_COMPILER_MSSDK71_VALUE);
    }

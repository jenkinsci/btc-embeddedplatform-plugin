...
/**
 * This class defines a basic test step in the overall Test Automation Report. The step has a name, an info attribute, a
 * duration a status and a verdict. The status reflects if there were any errors while the verdict reflects the
 * passed/failed result of test activities. The verdict can be absent for steps that don't provide one.
 * 
 * @author thabok
 */

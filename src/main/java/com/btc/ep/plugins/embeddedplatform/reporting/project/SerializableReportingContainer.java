...
/**
 * This class allows to serialize a report in order to continue with the data
 * another time. Essential for the Migration Suite scenario where not all test
 * steps are running in the same application life cycle (or even on the same
 * PC).
 * 
 * @author thabok
 */

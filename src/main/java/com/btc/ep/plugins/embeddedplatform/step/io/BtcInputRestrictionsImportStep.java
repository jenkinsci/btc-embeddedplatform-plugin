 ...
 */
class BtcInputRestrictionsImportStepExecution extends SynchronousNonBlockingStepExecution<Object> {
	...
	public Object run() {
		...
		InputRestrictionsImportExec exec = new InputRestrictionsImportExec(logger, getContext(), step);
...
class InputRestrictionsImportExec extends BtcExecution {

	private static final long serialVersionUID = 6097517206427293185L;
	private InputRestrictionsApi inputRestrictionsApi = new InputRestrictionsApi();
	private BtcInputRestrictionsImportStep step;

	public InputRestrictionsImportExec(PrintStream logger, StepContext context, BtcInputRestrictionsImportStep step) {
